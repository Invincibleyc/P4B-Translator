...
procedure {:inline 1} a_with_control_params(x:bv9)
	modifies forward, standard_metadata.egress_spec, meta.trap, meta.trap2;
{
...
procedure {:inline 1} ingress()
	modifies forward, hdr.ethernet.e, hdr.trap.trap, standard_metadata.egress_spec, t_exact_0.action_run, meta.trap, meta.trap2;
{
    hdr.ethernet.e := 1bv8;
    meta.trap := true;
    meta.trap2 := 1bv4;
...
procedure {:inline 1} main()
	modifies drop, forward, hdr.ethernet.e, hdr.trap.trap, isValid, standard_metadata.egress_spec, t_exact_0.action_run, meta.trap, meta.trap2;
{
    call ParserImpl();
    call verifyChecksum();
    call ingress();
...
procedure mainProcedure()
	modifies drop, emit, forward, hdr.ethernet.e, hdr.trap.trap, isValid, stack.index, standard_metadata.egress_spec, t_exact_0.action_run, meta.trap, meta.trap2;
{
...
procedure {:inline 1} t_exact_0.apply()
	modifies forward, hdr.ethernet.e, standard_metadata.egress_spec, t_exact_0.action_run, meta.trap, meta.trap2;
{
