...
_TABLEENTRY.fields_by_name['controller_metadata'].has_options = True
_TABLEENTRY.fields_by_name['controller_metadata']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
